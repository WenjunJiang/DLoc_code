...
opt_decoder.lr_decay_iters = 1 #type=int, default=50, help='multiply by a gamma every lr_decay_iters iterations')
...
opt_offset_decoder.lr_decay_iters = 1 #type=int, default=50, help='multiply by a gamma every lr_decay_iters iterations')
